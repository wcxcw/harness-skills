...
- Keeps `harness/context/project-brief.md` as the short default entry point and treats other context files as task-triggered reads.
...
```markdown
## Context Budget
- Default read: `harness/context/project-brief.md`
...
1. Start with `AGENTS.md`, `harness/context/project-brief.md`, `harness/controls/gates.md`, `harness/tools/commands.md`, and `harness/guardrails/boundaries.md`.
...
- Safe default: `harness/context/project-brief.md`, if it remains a short project summary.
